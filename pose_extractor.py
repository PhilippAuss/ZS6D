...
class PoseViTExtractor(extractor.ViTExtractor):
    ...
    def find_correspondences_fastknn(self, pil_img1, pil_img2, num_pairs: int = 10, load_size: int = 224, 
        ...
        cluster_ids_x, cluster_centers = kmeans(X = normalized, num_clusters=n_clusters, distance='euclidean', device=self.device)
