...
if __name__=="__main__":
    ...
    parser.add_argument('--config_file', default="./dino_pose_configs/cfg_ycbv_inference_bop.json")
    ...
    csv_file = './results/results_ycbv_bop_sam_10templates.csv'
    ...
    for obj_id, template_labels in tqdm(templates_gt.items()):
        ...
        templates_gt_new[obj_id] = [template_label for i, template_label in enumerate(template_labels)]
    ...
    for all_id, img_labels in tqdm(data_gt.items()):
        ...
        for i in range(len(img_data.crops)):
            ...
            if img_data.crops[i] is not None:
                matched_templates = utils.find_template_cpu(img_data.descs[i], templates_desc[object_id], num_results=10)
                ...
                for matched_template in matched_templates:
                    ...
                    # if debug and img_name == img_name_to_debug and img_data.obj_ids[i] == obj_name_to_debug:
                    #     print("hello")
            ...
            if True: #int(img_id) % 25 == 0:
                ...
                cv2.imwrite(f"./dbg_imgs_ycbv_mask_sam_10templates/{img_data.img_name}_{img_data.obj_ids[i]}.png", dbg_img_mask)
