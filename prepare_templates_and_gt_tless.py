...
if __name__=="__main__":
    root_dir = "./templates/tless"

    goal_dir = "./templates/tless_desc"

    gt_file = "./gts/tless_templates_gt_with_uv_desc.json"
    ...
    cam_K = np.array([1075.65091572, 0.0, 360,
                            0.0, 1073.90347929, 270,
                            0.0, 0.0, 1.0]).reshape((3,3))

    ren = Renderer((720, 540),cam_K)
    ...
    with open("./gts/tless_templates_gt_correct.json","w") as f:
